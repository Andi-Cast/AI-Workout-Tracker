...
public class WorkoutFeedbackController {
    ...
    @PostMapping
    public ResponseEntity<WorkoutFeedbackResponse> save(@RequestBody WorkoutFeedbackRequest request) {
        return ResponseEntity.ok(workoutFeedbackService.saveWorkoutFeedback(request));
    }

    @PutMapping("/{id}")
    public ResponseEntity<WorkoutFeedbackResponse> update(@PathVariable Long id, @RequestBody WorkoutFeedbackRequest request) {
